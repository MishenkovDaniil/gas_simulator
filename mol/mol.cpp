...
// {
//     for (int mol_idx = 0; mol_idx < mols.get_size (); mol_idx++)
//     {
...
//         if (wall_to_collide)// && (((wall_to_collide->normal_) || (mol1->v_)) <= 0))
//         {
//             wall_collide (mols[idx], wall_to_collide);
//             is_true = true;
//         }
//     }
...
//         for (int second  = idx + 1; second < size - 1; second++)
//         {
//             Mol *mol2 = mols[second];
//             if (mol1 == mol2)
//             {
//                 fprintf (stderr, "mol1 == mol2\n");
//                 continue;
//             }
...
// void Mol_manager::remove (int num)
// {
//     delete mols[num];
//     mols.rm (num);
// }
...
// bool Mol_manager::collide (Mol *mol1, Mol *mol2, int mol1_idx, int mol2_idx)
// {
//     assert (mol1 && mol2);
...
//     if (res == false)
//     {
//         if (mols.get_size () != size)
//         {
//             fprintf (stderr, "dfkopsmfksf\n");
//             while (1)
//                 ; 
//         }
//         return false;
...
//         manager.create (1, SQUARE_MOL, speed, new_mol_mass, SQUARE_COLOR, v, pos); // m= m + 1
...
//     for (int idx = 0; idx < mols.get_size (); ++idx)
//     {
//         Mol *mol = (mols[idx]);
...
{ 
    ...
    mols = (Mol **)calloc (1000, sizeof (Mol *));capacity_ = 1000;
}
